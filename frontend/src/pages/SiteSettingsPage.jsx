...
const KARA_SCHEMA_GROUPS = {
  // تب «نگاشت تردد»
  datafile: "ستون‌های تکمیلی جدول تردد (اعمال مرخصی/ماموریت ساعتی؛ Modify/Direction/VT/AC برای درج تردد فراموش‌شده)",
  ...
  wf_moveup: "جدول صعود/ارجاع (ارجاع تردد فراموش‌شده از سرپرست به مسئول نیروی انسانی)",

    ...
    <Box>
      ...
      <Accordion variant="outlined" sx={{ mb: 2 }}>
        ...
        <AccordionDetails>
          ...
          <Typography variant="body2" fontWeight={700} sx={{ mb: 0.5 }}>
            قدم ۴ - انتخاب نوع سوال (هرکدوم یعنی چی، با مثال محاسبه)
          </Typography>
          <Stack component="ul" sx={{ pl: 2.5, m: 0, mb: 1.5 }} spacing={1}>
            <Typography component="li" variant="body2">
              <b>تک‌انتخابی</b>: فقط یکی از گزینه‌ها انتخاب می‌شه. مثال: «کیفیت کار چطوره؟» با گزینه‌های
              ضعیف/متوسط/خوب/عالی. امتیاز این سوال = امتیاز همون یک گزینه‌ی انتخاب‌شده (بعد از نرمالایز
              شدن نسبت به بهترین گزینه - قدم ۵ رو ببینید).
            </Typography>
            <Typography component="li" variant="body2">
              <b>چندانتخابی</b>: می‌شه هم‌زمان چند گزینه رو انتخاب کرد. مثال: «کدوم مهارت‌ها رو داره؟»
              با گزینه‌های تیم‌کاری/رهبری/دقت/سرعت (هرکدوم امتیاز جدا). اگه ارزیاب ۲ تا از ۴ گزینه رو
              انتخاب کنه، امتیاز این سوال = میانگین همون ۲ گزینه انتخاب‌شده (نه هر ۴ تا).
            </Typography>
            <Typography component="li" variant="body2">
              <b>امتیازی</b>: از نظر ساخت دقیقاً مثل تک‌انتخابیه (باز هم گزینه با امتیاز تعریف می‌کنید) -
              فقط برای سوال‌هایی که حس «امتیازدهی» دارن (مثلاً از ۱ تا ۵) استفاده کنید. مثال در قدم ۵.
            </Typography>
            <Typography component="li" variant="body2">
              <b>بله/خیر</b>: یه سوال ساده با دو گزینه (مثلاً «بله» امتیاز ۱۰۰ و «خیر» امتیاز ۰) که
              خودتون امتیاز هرکدوم رو مشخص می‌کنید - می‌تونید برعکسش هم بکنید (مثلاً برای سوالی که «خیر»
              جواب درسته).
            </Typography>
            <Typography component="li" variant="body2">
              <b>متن آزاد</b>: ارزیاب یه توضیح می‌نویسه (بدون گزینه). امتیاز این سوال ساده است: اگه چیزی
              نوشته بشه (حتی یک کلمه) → ۱۰۰؛ اگه خالی بمونه → ۰. یعنی این نوع سوال بیشتر برای «حتماً یه
              توضیح بنویس» مناسبه، نه برای سنجش کیفیت خودِ متن.
            </Typography>
            <Typography component="li" variant="body2">
              <b>عدد</b>: ارزیاب یه عدد بین ۰ تا وزن همون سوال وارد می‌کنه - این عدد مستقیماً همون
              مقدار امتیازی است که این سوال می‌گیره (نه پاسخ داده‌شده/نداده‌شده). مثال: اگه وزن سوال ۲۰
              باشه، ارزیاب بین ۰ تا ۲۰ وارد می‌کنه؛ اگه ۱۲ بزنه، یعنی این سوال ۱۲ امتیاز از ۲۰ امتیاز
              ممکنش گرفته (معادل ۶۰٪ همون سوال).
            </Typography>
            <Typography component="li" variant="body2">
              <b>تاریخ</b>: ارزیاب یه تاریخ وارد می‌کنه (بدون گزینه) - دقیقاً مثل متن آزاد، فقط «پاسخ
              داده شده یا نه» سنجیده می‌شه (۱۰۰ یا ۰).
            </Typography>
          </Stack>
          ...
          <Typography variant="body2" sx={{ mb: 1 }}>
            هر گزینه یه «متن» داره (مثلاً «خوب») و یه «امتیاز» عددی. ⚠️ نکته مهم: <b>لازم نیست حتماً از
            مقیاس ۰ تا ۱۰۰ استفاده کنید</b> - سیستم خودکار امتیاز گزینه‌ها را نسبت به «بهترین گزینه‌ی
            همون سوال» نرمالایز می‌کند؛ یعنی هر مقیاسی که داخلش منسجم باشد، درست کار می‌کند. برای مثال
            این دو روش، نتیجه‌ی کاملاً یکسانی تولید می‌کنند:
          </Typography>
          <Typography variant="body2" sx={{ mb: 0.5, pl: 1 }}>
            <b>روش اول - مقیاس ۰ تا ۱۰۰:</b>
            <br />
            خیلی ضعیف ← ۰ &nbsp;|&nbsp; ضعیف ← ۲۵ &nbsp;|&nbsp; متوسط ← ۵۰ &nbsp;|&nbsp; خوب ← ۷۵
            &nbsp;|&nbsp; عالی ← ۱۰۰
          </Typography>
          <Typography variant="body2" sx={{ mb: 1.5, pl: 1 }}>
            <b>روش دوم - مقیاس ۰ تا ۵ (مثل سوالات امتیازی رایج):</b>
            <br />
            خیلی ضعیف ← ۰ &nbsp;|&nbsp; ضعیف ← ۱ &nbsp;|&nbsp; متوسط ← ۲ &nbsp;|&nbsp; خوب ← ۳
            &nbsp;|&nbsp; بسیار خوب ← ۴ &nbsp;|&nbsp; عالی ← ۵
            <br />
            چون بزرگ‌ترین گزینه همین سوال ۵ است، انتخاب «عالی» دقیقاً ۱۰۰٪ همین سوال حساب می‌شود -
            درست مثل روش اول؛ انتخاب «خوب» (۳ از ۵) هم دقیقاً معادل ۶۰٪ همین سوال است.
          </Typography>
          <Typography variant="body2" sx={{ mb: 1.5 }}>
            (سوال‌های متن/تاریخ گزینه لازم ندارن. سوال عددی هم گزینه نداره - امتیازش از روی خودِ عدد
            واردشده حساب می‌شه، طبق قدم ۴.)
          </Typography>

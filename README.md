...
2. در غیر این‌صورت، به‌صورت خودکار دنبال **DejaVu Sans** می‌گردد (مسیر
   استاندارد `/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf`) — این فونت
   معمولاً از قبل روی توزیع‌های اوبونتو/دبیان نصب است و حروف فارسی/عربی را
   به‌طور کامل دارد، پس **در بیشتر نصب‌ها بدون هیچ اقدام دستی، PDF فارسی
   درست نمایش داده می‌شود**.
